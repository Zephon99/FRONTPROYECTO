...
@Component({
  selector: "app-sales-overview-2",
  templateUrl: "./sales-overview-2.component.html"
})
export class SalesOverview2Component implements OnInit {
 ...
 /* getNombreParqueos():void{
  ...
  getCantidadMesReservas():void{

    this.parqueoVistaService.getMesParqueos().pipe(
      tap(parqueos =>  {
